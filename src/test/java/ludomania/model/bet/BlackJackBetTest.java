...
public class BlackJackBetTest {
    ...
    public void TestTypeNameAndPayout() {
        // Test BASE
        assertEquals("Base", BlackJackBetType.BASE.getTypeName());
        assertEquals(1.0, BlackJackBetType.BASE.getPayout());

        // Test DOUBLE
        assertEquals("Double", BlackJackBetType.DOUBLE.getTypeName());
        assertEquals(2.0, BlackJackBetType.DOUBLE.getPayout());
