 ...
 * 
 * <p>
 * Implementations represent the card theme and provide information about
 * the associated cosmetic style and theme type for specific card ranks and
 * suits.
 */

public interface CardTheme {
    /**
     * Returns the SVG string associated with a specific card, based on its rank and
     * suit.
     * The string contains the raw SVG markup to render the card visually.
     * 
